...
export default function RenameModal() {
  ...
  const isModalOpen = useSelector((state) => state.renameModal.isOpen);

  function handleModalClose() {
    try {
      dispatch(requestRenameModalClose());
      dispatch(setRenameModalClose());
      dispatch(reciveRenameModalClose());
    } catch (exception) {
      dispatch(renameModalProccedingError(exception.message));
    }
  }
